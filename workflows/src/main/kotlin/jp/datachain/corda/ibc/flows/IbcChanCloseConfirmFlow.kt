...
object IbcChanCloseConfirmFlow {
    @StartableByRPC
    @InitiatingFlow
    class Initiator(
        ...
        override fun call() : SignedTransaction {
            ...
            val newChan = Quadruple(host.state.data, client.state.data, conn.state.data, chan.state.data).chanCloseConfirm(
                    portIdentifier,
                    channelIdentifier,
                    proofInit,
                    proofHeight)

            builder.addCommand(Ibc.Commands.ChanCloseConfirm(
                    portIdentifier,
                    channelIdentifier,
                    proofInit,
                    proofHeight
